...
I currently work at **CSG International**, where I build solutions for the telecom industry. Previously, I was at **Paper.id**, where I architected payment engines handling billions of rupiah in transactions.

Some highlights from my journey:

- Built unified payment engines supporting QRIS, virtual accounts, and cross-border remittances
- Implemented systems achieving **99% transaction success rate**
- Contributed to projects winning industry awards like **TMForum DTW 2025**

## Let's Connect

Feel free to reach out if you want to discuss tech, collaborate on projects, or just say hi!

- [GitHub](https://github.com/dennisheraldi)
- [LinkedIn](https://linkedin.com/in/dennisheraldi)
